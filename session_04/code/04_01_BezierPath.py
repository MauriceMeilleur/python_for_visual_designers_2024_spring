...
myShape.curveTo(
    (width(), myShapeHeight+myHandleLength), # offcurve point/handle 1
    (0, myShapeHeight + myHandleLength), # offcurve point/handle 2
    (0, myShapeHeight) # oncurve point
    )

# now that we are done defining the shape
